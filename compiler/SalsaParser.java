 ...
 */
  ...
  static final public CInterfaceDeclaration InterfaceDeclaration() throws ParseException {
    ...
    try {
      ...
      t = jj_consume_token(IDENTIFIER);
                                                                                                                                          interface_declaration.interface_name = t.image;
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case EXTENDS:
        jj_consume_token(EXTENDS);
        name = Name();
                                                                                          interface_declaration.extends_name = name.name;
        break;
      default:
        jj_la1[6] = jj_gen;
        ;
  ...
  static final public CBehaviorDeclaration BehaviorDeclaration() throws ParseException {
    ...
    try {
      ...
      t = jj_consume_token(IDENTIFIER);
                                                                                                                                          behavior_declaration.behavior_name = t.image;
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case EXTENDS:
        jj_consume_token(EXTENDS);
        name = Name();
                                                                                                                                          behavior_declaration.extends_name = name.name;
        break;
      default:
        jj_la1[9] = jj_gen;
        ;
      ...
      case IMPLEMENTS:
        ...
        name = Name();
                                                                                                                                          behavior_declaration.implements_names.add(name.name);
        label_5:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case COMMA:
  ...
  static final public CLocalVariableDeclaration ForInit() throws ParseException {
    ...
    try {
      type = Type();
                                                                  local_variable_declaration.type = type.name;
  ...
  static final public CValue Value() throws ParseException {
    ...
    try {
      if (jj_2_17(2147483647)) {
        ...
        type = Type();
        jj_consume_token(RPAREN);
                                                                                              value.cast_type = type.name; value.initLineAndColumnBegin(beginToken); hasBegin = true;
      } else {
        ;
      }
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
