 ...
 */
  ...
  static final public CGenericType GenericType() throws ParseException {
    ...
    try {
      if (jj_2_2(2147483647)) {
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case EXTENDS:
          modifier = jj_consume_token(EXTENDS);
          break;
        case SUPER:
          modifier = jj_consume_token(SUPER);
          break;
        default:
          jj_la1[3] = jj_gen;
          jj_consume_token(-1);
  ...
  static final public CInterfaceDeclaration InterfaceDeclaration() throws ParseException {
    ...
    try {
      ...
      case EXTENDS:
        ...
        name = Name();
                                                                                      interface_declaration.extends_names.add(name);
        label_5:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case COMMA:
    ...
    try {
      ...
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                                                                                                  behavior_declaration.is_abstract = true;
        break;
      default:
        jj_la1[16] = jj_gen;
        ;
  ...
  static final public CMessageHandler MessageHandlerDeclaration() throws ParseException {
    ...
    try {
      ...
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                                  message_handler.is_abstract = true;
        break;
      default:
        jj_la1[26] = jj_gen;
        ;
...
//            System.err.println("pass statement on line " + t.beginLine + " will pass later");
  ...
  static final public CExtendedFor ExtendedFor() throws ParseException {
                              /*@bgen(jjtree) ExtendedFor */
    SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(JJTEXTENDEDFOR);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtreeOpenNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));CExtendedFor extended_for = new CExtendedFor();
    CType type;
    Token name;
  ...
  static final public CForStatement ForStatement() throws ParseException {
    ...
    try {
      ...
      if (jj_2_16(2147483647)) {
        for_statement.extended_for = ExtendedFor();
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case ACK:
        case BOOLEAN:
  ...
  static final public CSynchronizedStatement SynchronizedStatement() throws ParseException {
                                                  /*@bgen(jjtree) SynchronizedStatement */
    SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(JJTSYNCHRONIZEDSTATEMENT);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtreeOpenNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));CSynchronizedStatement synchronized_statement = new CSynchronizedStatement();
    Token t1;
    try {
      t1 = jj_consume_token(SYNCHRONIZED);
      jj_consume_token(LPAREN);
      synchronized_statement.expression = Expression();
      jj_consume_token(RPAREN);
      synchronized_statement.block = Block();
      jjtree.closeNodeScope(jjtn000, true);
      jjtc000 = false;
      jjtreeCloseNodeScope(jjtn000);
      jjtn000.jjtSetLastToken(getToken(0));
        synchronized_statement.initLineAndColumn(t1, synchronized_statement.block);
        {if (true) return synchronized_statement;}
    } catch (Throwable jjte000) {
      if (jjtc000) {
        jjtree.clearNodeScope(jjtn000);
        jjtc000 = false;
  ...
  static final public CTryStatement TryStatement() throws ParseException {
                                /*@bgen(jjtree) TryStatement */
    SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(JJTTRYSTATEMENT);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtreeOpenNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));CTryStatement try_statement = new CTryStatement();
    CBlock catch_block = null;
    Vector<CFormalParameter> parameters = null;
    try {
      jj_consume_token(TRY);
      try_statement.try_block = Block();
  ...
  static final public CContinueStatement ContinueStatement() throws ParseException {
                                          /*@bgen(jjtree) ContinueStatement */
    SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(JJTCONTINUESTATEMENT);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtreeOpenNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));CContinueStatement continue_statement = new CContinueStatement();
    try {
      ...
      jjtreeCloseNodeScope(jjtn000);
      jjtn000.jjtSetLastToken(getToken(0));
      {if (true) return continue_statement;}
    } finally {
      if (jjtc000) {
        jjtree.closeNodeScope(jjtn000, true);
        jjtreeCloseNodeScope(jjtn000);
  ...
  static final public CValue Value() throws ParseException {
    ...
    try {
      if (jj_2_20(2147483647)) {
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case _TOKEN:
          tokenToken = jj_consume_token(_TOKEN);
          break;
        default:
          jj_la1[53] = jj_gen;
          ;
        ...
        type = Type();
        jj_consume_token(RPAREN);
                                                                                                  value.cast_type = type; value.initLineAndColumnBegin(beginToken); hasBegin = true; value.cast_type.is_token = (tokenToken != null);
      } else {
        ;
      }
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public void BindDeclaration(CAllocation allocation) throws ParseException {
    ...
    try {
      ...
      case CALLED:
        ...
        jj_consume_token(LPAREN);
        expression = Expression();
                                                          allocation.called_expression = expression;
        jj_consume_token(RPAREN);
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case USING:
          ...
          jj_consume_token(LPAREN);
          expression = Expression();
                                                          allocation.nameserver_expression = expression;
          jj_consume_token(RPAREN);
          break;
        default:
          jj_la1[63] = jj_gen;
        ...
        case AT:
          ...
          jj_consume_token(LPAREN);
          expression = Expression();
                                                          allocation.host_expression = expression;
          jj_consume_token(COMMA);
          expression = Expression();
                                                          allocation.port_expression = expression;
          jj_consume_token(RPAREN);
          break;
        default:
          jj_la1[64] = jj_gen;
        ...
        case ON:
          ...
          jj_consume_token(LPAREN);
          expression = Expression();
                                                      allocation.stage_expression = expression;
          jj_consume_token(RPAREN);
          break;
        default:
          jj_la1[65] = jj_gen;
  ...
  static final private int[] jj_la1 = new int[72];
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x108a4000,0x108a4000,0x2000,0x0,0x0,0x0,0x308a6000,0x108a4000,0x0,0x108a4000,0x0,0x108a4000,0x2000,0x0,0x0,0x108a4000,0x16ae4000,0x0,0x0,0x6240000,0x4000,0x4000,0x4000,0x4000,0x108a4000,0x108a4000,0x400000,0x16ae4000,0x0,0x4000,0x0,0x4000,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0x0,0x0,0x8000000,0x0,0x4000,0x100000,0x108a4000,0x0,0x0,0x8000,0x0,0x100000,0x0,0x4000,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x2000,0x40,0x200,0x1000001,0x1000001,0x0,0x0,0x0,0x0,0x10000,0x0,0x0,0x0,0x1,0x8800904,0x8800904,0x0,0x1,0x0,0x20,0x8800904,0x8800904,0x0,0x800904,0x0,0x800904,0x0,0x0,0x0,0x800904,0x3eecc91e,0x0,0x0,0x26040018,0x1068c002,0x1068c402,0x1068c402,0x1068c002,0x10e8c906,0x10e8c906,0x0,0x3eecc91e,0x8000000,0x1068c002,0x0,0x1068c002,0x1068c002,0x0,0x0,0x0,0x0,0x80,0x80,0x8000000,0x1068c002,0x0,0x0,0x80000000,0x0,0x1068c002,0x20000,0x800904,0x204000,0x40000000,0x0,0x20000,0x20000,0x0,0x10488002,0x10000002,0x0,0x80,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x200,0x80000,0x1000000,0x0,0x0,0x100000,0x80000,0x0,0x200,0x200,0x0,0x0,0x80000,0x0,0x200,0x200,0x80000,0x200,0x10000,0x0,0x0,0x44000,0x80000,0x200,0x60053a3,0x40000,0x40000,0x4001,0x60013a2,0x60013a2,0x60013a2,0x60013a2,0x60013a2,0x60413a2,0x0,0x60053a3,0x0,0x60053a2,0x80000,0x60053a2,0x60053a2,0x6000000,0x6000000,0x0,0x0,0xf1c00000,0xf1c00000,0x0,0x13a2,0x310000,0x100000,0x0,0x80000,0x60013a2,0x0,0x200,0x0,0x0,0x0,0x0,0x0,0x10000,0x1a2,0x0,0x400000,0xf1800000,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x4000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2c,0x8000000,0x8000000,0x0,0x2c,0x2c,0x2c,0x2c,0x2c,0x2c,0x0,0x2c,0x0,0x2c,0x0,0x2c,0x2c,0x2c,0x2c,0xc,0xc,0x3fffff3,0x3fffff3,0x0,0x0,0x0,0x0,0x0,0x0,0x2c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3ff8000,0x7ff3,};
   }
