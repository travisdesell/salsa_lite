  ...
  static final public CName Name() throws ParseException {
    ...
    try {
      t = jj_consume_token(IDENTIFIER);
                                          name.name = t.image; name.initLineAndColumnBegin(t);
      label_2:
      while (true) {
