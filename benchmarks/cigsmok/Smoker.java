...
public class Smoker extends salsa_lite.runtime.Actor implements java.io.Serializable {
    ...
    public Object writeReplace() throws java.io.ObjectStreamException {
        ...
        return new SerializedSmoker( this.hashCode(), TransportService.getHost(), TransportService.getPort() );
    }

    public static class RemoteReference extends Smoker {
        ...
        public Object writeReplace() throws java.io.ObjectStreamException {
            return new SerializedSmoker( hashCode, host, port);
        }
    }

    public static class SerializedSmoker implements java.io.Serializable {
        int hashCode;
        String host;
        int port;

        SerializedSmoker(int hashCode, String host, int port) { this.hashCode = hashCode; this.host = host; this.port = port; }

        public Object readResolve() throws java.io.ObjectStreamException {
            int hashCode = Hashing.getHashCodeFor(this.hashCode, this.host, this.port);
            synchronized (LocalActorRegistry.getLock(hashCode)) {
                Smoker actor = (Smoker)LocalActorRegistry.getEntry(hashCode);
                if (actor == null) {
    ...
    public String getMessageInformation(int messageId) {
    	switch (messageId) {
    		...
    		case 3: return "ack [salsa_lite.benchmarks.cigsmok.Smoker].StartSmoke(long)";
    	}
    	return "No message with specified id.";
    }

    public Smoker() { super(); }
    public Smoker(int stage_id) { super(stage_id); }
    ...
    public Object invokeMessage(int messageId, Object[] arguments) throws RemoteMessageException, TokenPassException, MessageHandlerNotFoundException {
        switch(messageId) {
            ...
            case 3: StartSmoke( (Long)arguments[0] ); return null;
    ...
    public void invokeConstructor(int messageId, Object[] arguments) throws RemoteMessageException, ConstructorNotFoundException {
        switch(messageId) {
            case 0: construct( (Arbiter)arguments[0], (Integer)arguments[1] ); return;
            default: throw new ConstructorNotFoundException(messageId, arguments);
        }
    }

    public void construct(Arbiter a, int i) {
        id = i;
        arbiter = a;
    }
    ...
    public void StartSmoke(long time) {
        StageService.sendMessage(arbiter, 3 /*StartedSmoking*/, null);
        try {
            Thread.sleep(time);
        }
    ...
    public static Smoker construct(int constructor_id, Object[] arguments) {
        Smoker actor = new Smoker();
        StageService.sendMessage(new Message(Message.CONSTRUCT_MESSAGE, actor, constructor_id, arguments));
        return actor;
    }

    public static Smoker construct(int constructor_id, Object[] arguments, int target_stage_id) {
        Smoker actor = new Smoker(target_stage_id);
